...
import { m as merge, b as map, t as take, S as Subject, O as Observable } from '../common/share-be0afb7a.js';
import { f as filter, s as switchMap, o as of, t as tap, B as BehaviorSubject } from '../common/tap-9d36a830.js';
import { t as takeUntil, f as fromEvent } from '../common/takeUntil-52a5d0b5.js';
import { d as debounceTime, a as asapScheduler } from '../common/debounceTime-30b0eb6f.js';
import '../common/mapOneOrManyArgs-b29deeaa.js';
import { A as APP_BOOTSTRAP_LISTENER, P as PLATFORM_ID, ɵ as ɵɵdefineInjectable, I as Injectable, a as InjectionToken, i as inject, b as ɵɵinject, c as Inject, N as NgZone, d as NgModule, D as Directive, E as ElementRef, e as Input, f as IterableDiffers, K as KeyValueDiffers, R as Renderer2, O as Optional, S as Self, g as SecurityContext, h as ɵɵngDeclareFactory, j as i0, F as FactoryTarget, k as ɵɵngDeclareInjectable, l as ɵɵngDeclareClassMetadata, m as ɵɵngDeclareDirective, n as Output, o as ɵɵngDeclareNgModule, p as ɵɵngDeclareInjector, q as EventEmitter, V as Version } from '../common/core-db55d383.js';
import { isPlatformBrowser, DOCUMENT, isPlatformServer, NgClass, NgStyle } from '@angular/common';
...
Directionality.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.3.0", ngImport: i0, type: Directionality, deps: [{ token: DIR_DOCUMENT, optional: true }], target: FactoryTarget.Injectable });
Directionality.ɵprov = ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "13.3.0", ngImport: i0, type: Directionality, providedIn: 'root' });
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.0", ngImport: i0, type: Directionality, decorators: [{
            type: Injectable,
...
Dir.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.3.0", ngImport: i0, type: Dir, deps: [], target: FactoryTarget.Directive });
Dir.ɵdir = ɵɵngDeclareDirective({ minVersion: "12.0.0", version: "13.3.0", type: Dir, selector: "[dir]", inputs: { dir: "dir" }, outputs: { change: "dirChange" }, host: { properties: { "attr.dir": "_rawDir" } }, providers: [{ provide: Directionality, useExisting: Dir }], exportAs: ["dir"], ngImport: i0 });
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.0", ngImport: i0, type: Dir, decorators: [{
            type: Directive,
            args: [{
                    selector: '[dir]',
...
BidiModule.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.3.0", ngImport: i0, type: BidiModule, deps: [], target: FactoryTarget.NgModule });
BidiModule.ɵmod = ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "13.3.0", ngImport: i0, type: BidiModule, declarations: [Dir], exports: [Dir] });
BidiModule.ɵinj = ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "13.3.0", ngImport: i0, type: BidiModule });
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.0", ngImport: i0, type: BidiModule, decorators: [{
            type: NgModule,
            args: [{
                    exports: [Dir],
                    declarations: [Dir],
...
var DefaultLayoutGapDirective = /** @class */ (function (_super) {
    ...
    DefaultLayoutGapDirective.decorators = [
        { type: Directive, args: [{ selector: selector$1$1, inputs: inputs$1$1 },] }
    ];
...
var DefaultFlexDirective = /** @class */ (function (_super) {
    ...
    DefaultFlexDirective.decorators = [
        { type: Directive, args: [{ inputs: inputs$2$1, selector: selector$2$1 },] }
    ];
...
var DefaultFlexOrderDirective = /** @class */ (function (_super) {
    ...
    DefaultFlexOrderDirective.decorators = [
        { type: Directive, args: [{ selector: selector$3$1, inputs: inputs$3$1 },] }
    ];
...
var DefaultFlexOffsetDirective = /** @class */ (function (_super) {
    ...
    DefaultFlexOffsetDirective.decorators = [
        { type: Directive, args: [{ selector: selector$4$1, inputs: inputs$4$1 },] }
    ];
...
var DefaultGridAlignColumnsDirective = /** @class */ (function (_super) {
    ...
    DefaultGridAlignColumnsDirective.decorators = [
        { type: Directive, args: [{ selector: selector$1$2, inputs: inputs$1$2 },] }
    ];
...
var DefaultGridAlignRowsDirective = /** @class */ (function (_super) {
    ...
    DefaultGridAlignRowsDirective.decorators = [
        { type: Directive, args: [{ selector: selector$2$2, inputs: inputs$2$2 },] }
    ];
...
var DefaultGridAreaDirective = /** @class */ (function (_super) {
    ...
    DefaultGridAreaDirective.decorators = [
        { type: Directive, args: [{ selector: selector$3$2, inputs: inputs$3$2 },] }
    ];
...
var DefaultGridAreasDirective = /** @class */ (function (_super) {
    ...
    DefaultGridAreasDirective.decorators = [
        { type: Directive, args: [{ selector: selector$4$2, inputs: inputs$4$2 },] }
    ];
...
var DefaultGridAutoDirective = /** @class */ (function (_super) {
    ...
    DefaultGridAutoDirective.decorators = [
        { type: Directive, args: [{ selector: selector$5$1, inputs: inputs$5$1 },] }
    ];
...
var DefaultGridColumnDirective = /** @class */ (function (_super) {
    ...
    DefaultGridColumnDirective.decorators = [
        { type: Directive, args: [{ selector: selector$6$1, inputs: inputs$6$1 },] }
    ];
...
var DefaultGridColumnsDirective = /** @class */ (function (_super) {
    ...
    DefaultGridColumnsDirective.decorators = [
        { type: Directive, args: [{ selector: selector$7$1, inputs: inputs$7$1 },] }
    ];
...
export { BREAKPOINT, BREAKPOINTS, BREAKPOINT_PRINT, BROWSER_PROVIDER, BaseDirective2, BreakPointRegistry, CLASS_NAME, ClassDirective, CoreModule, DEFAULT_BREAKPOINTS, DEFAULT_CONFIG, DefaultClassDirective, DefaultFlexAlignDirective, DefaultFlexDirective, DefaultFlexOffsetDirective, DefaultFlexOrderDirective, DefaultImgSrcDirective, DefaultLayoutAlignDirective, DefaultLayoutDirective, DefaultLayoutGapDirective, DefaultShowHideDirective, DefaultStyleDirective, ExtendedModule, FlexAlignDirective, FlexAlignStyleBuilder, FlexDirective, FlexFillDirective, FlexFillStyleBuilder, FlexLayoutModule, FlexModule, FlexOffsetDirective, FlexOffsetStyleBuilder, FlexOrderDirective, FlexOrderStyleBuilder, FlexStyleBuilder, GridModule, ImgSrcDirective, ImgSrcStyleBuilder, LAYOUT_CONFIG, LayoutAlignDirective, LayoutAlignStyleBuilder, LayoutDirective, LayoutGapDirective, LayoutGapStyleBuilder, LayoutStyleBuilder, MediaChange, MediaMarshaller, MediaObserver, MediaTrigger, ORIENTATION_BREAKPOINTS, PrintHook, SERVER_TOKEN, ScreenTypes, ShowHideDirective, ShowHideStyleBuilder, StyleBuilder, StyleDirective, StyleUtils, StylesheetMap, VERSION, coerceArray, mergeAlias, removeStyles, sortAscendingPriority, sortDescendingPriority, validateBasis, MatchMedia as ɵMatchMedia, MockMatchMedia as ɵMockMatchMedia, MockMatchMediaProvider as ɵMockMatchMediaProvider, GridAlignStyleBuilder as ɵgrid_privatea, GridAlignDirective as ɵgrid_privateb, DefaultGridGapDirective as ɵgrid_privateba, GridRowStyleBuilder as ɵgrid_privatebb, GridRowDirective as ɵgrid_privatebc, DefaultGridRowDirective as ɵgrid_privatebd, GridRowsStyleBuilder as ɵgrid_privatebe, GridRowsDirective as ɵgrid_privatebf, DefaultGridRowsDirective as ɵgrid_privatebg, DefaultGridAlignDirective as ɵgrid_privatec, GridAlignColumnsStyleBuilder as ɵgrid_privated, GridAlignColumnsDirective as ɵgrid_privatee, DefaultGridAlignColumnsDirective as ɵgrid_privatef, GridAlignRowsStyleBuilder as ɵgrid_privateg, GridAlignRowsDirective as ɵgrid_privateh, DefaultGridAlignRowsDirective as ɵgrid_privatei, GridAreaStyleBuilder as ɵgrid_privatej, GridAreaDirective as ɵgrid_privatek, DefaultGridAreaDirective as ɵgrid_privatel, GridAreasStyleBuiler as ɵgrid_privatem, GridAreasDirective as ɵgrid_privaten, DefaultGridAreasDirective as ɵgrid_privateo, GridAutoStyleBuilder as ɵgrid_privatep, GridAutoDirective as ɵgrid_privateq, DefaultGridAutoDirective as ɵgrid_privater, GridColumnStyleBuilder as ɵgrid_privates, GridColumnDirective as ɵgrid_privatet, DefaultGridColumnDirective as ɵgrid_privateu, GridColumnsStyleBuilder as ɵgrid_privatev, GridColumnsDirective as ɵgrid_privatew, DefaultGridColumnsDirective as ɵgrid_privatex, GridGapStyleBuilder as ɵgrid_privatey, GridGapDirective as ɵgrid_privatez };
