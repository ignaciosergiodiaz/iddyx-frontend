import 'tslib';
import { b as map, S as Subject, E as EMPTY, j as mergeMap, f as from, t as take, l as mergeAll, O as Observable } from '../common/share-be0afb7a.js';
import { f as first, c as concatMap, s as scan, t as takeLast, a as finalize, b as catchError, l as last$1, E as EmptyError, d as defer, C as ConnectableObservable, r as refCount } from '../common/scan-6459e222.js';
import { B as BehaviorSubject, f as filter, s as switchMap, o as of, t as tap } from '../common/tap-9d36a830.js';
import '../common/mapOneOrManyArgs-b29deeaa.js';
import '../common/createObject-ac6f401d.js';
import { c as concat, a as combineLatest, s as startWith } from '../common/startWith-cc256e45.js';
import { q as EventEmitter, h as ɵɵngDeclareFactory, j as i0, x as ViewContainerRef, C as ComponentFactoryResolver$1, y as ChangeDetectorRef, F as FactoryTarget, m as ɵɵngDeclareDirective, l as ɵɵngDeclareClassMetadata, D as Directive, z as Attribute, n as Output, B as ɵɵngDeclareComponent, G as Component, a as InjectionToken, J as NgModuleRef$1, L as Console, N as NgZone, k as ɵɵngDeclareInjectable, I as Injectable, T as Type, t as Injector, M as Compiler, R as Renderer2, E as ElementRef, e as Input, Q as HostListener, U as HostBinding, O as Optional, W as ContentChildren, X as ANALYZE_FOR_ENTRY_COMPONENTS, s as SkipSelf, c as Inject, Y as NgProbeToken, Z as APP_INITIALIZER, A as APP_BOOTSTRAP_LISTENER, o as ɵɵngDeclareNgModule, p as ɵɵngDeclareInjector, d as NgModule, _ as ApplicationRef, V as Version, $ as InjectFlags, a0 as NgModuleFactory$1, v as isObservable, u as isPromise } from '../common/core-db55d383.js';
...
RouterOutlet.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: RouterOutlet, deps: [{ token: ChildrenOutletContexts }, { token: ViewContainerRef }, { token: ComponentFactoryResolver$1 }, { token: 'name', attribute: true }, { token: ChangeDetectorRef }], target: FactoryTarget.Directive });
RouterOutlet.ɵdir = ɵɵngDeclareDirective({ minVersion: "12.0.0", version: "13.1.3", type: RouterOutlet, selector: "router-outlet", outputs: { activateEvents: "activate", deactivateEvents: "deactivate", attachEvents: "attach", detachEvents: "detach" }, exportAs: ["outlet"], ngImport: i0 });
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: RouterOutlet, decorators: [{
            type: Directive,
            args: [{ selector: 'router-outlet', exportAs: 'outlet' }]
        }], ctorParameters: function () {
        return [{ type: ChildrenOutletContexts }, { type: ViewContainerRef }, { type: ComponentFactoryResolver$1 }, { type: undefined, decorators: [{
                        type: Attribute,
                        args: ['name']
...
ɵEmptyOutletComponent.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: ɵEmptyOutletComponent, deps: [], target: FactoryTarget.Component });
ɵEmptyOutletComponent.ɵcmp = ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "13.1.3", type: ɵEmptyOutletComponent, selector: "ng-component", ngImport: i0, template: `<router-outlet></router-outlet>`, isInline: true, directives: [{ type: RouterOutlet, selector: "router-outlet", outputs: ["activate", "deactivate", "attach", "detach"], exportAs: ["outlet"] }] });
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: ɵEmptyOutletComponent, decorators: [{
            type: Component,
...
Router.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: Router, deps: "invalid", target: FactoryTarget.Injectable });
Router.ɵprov = ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: Router });
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: Router, decorators: [{
            type: Injectable
        }], ctorParameters: function () { return [{ type: Type }, { type: UrlSerializer }, { type: ChildrenOutletContexts }, { type: Location }, { type: Injector }, { type: Compiler }, { type: undefined }]; } });
...
RouterLink.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: RouterLink, deps: [{ token: Router }, { token: ActivatedRoute }, { token: 'tabindex', attribute: true }, { token: Renderer2 }, { token: ElementRef }], target: FactoryTarget.Directive });
RouterLink.ɵdir = ɵɵngDeclareDirective({ minVersion: "12.0.0", version: "13.1.3", type: RouterLink, selector: ":not(a):not(area)[routerLink]", inputs: { queryParams: "queryParams", fragment: "fragment", queryParamsHandling: "queryParamsHandling", preserveFragment: "preserveFragment", skipLocationChange: "skipLocationChange", replaceUrl: "replaceUrl", state: "state", relativeTo: "relativeTo", routerLink: "routerLink" }, host: { listeners: { "click": "onClick()" } }, usesOnChanges: true, ngImport: i0 });
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: RouterLink, decorators: [{
            type: Directive,
...
RouterLinkWithHref.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: RouterLinkWithHref, deps: [{ token: Router }, { token: ActivatedRoute }, { token: LocationStrategy }], target: FactoryTarget.Directive });
RouterLinkWithHref.ɵdir = ɵɵngDeclareDirective({ minVersion: "12.0.0", version: "13.1.3", type: RouterLinkWithHref, selector: "a[routerLink],area[routerLink]", inputs: { target: "target", queryParams: "queryParams", fragment: "fragment", queryParamsHandling: "queryParamsHandling", preserveFragment: "preserveFragment", skipLocationChange: "skipLocationChange", replaceUrl: "replaceUrl", state: "state", relativeTo: "relativeTo", routerLink: "routerLink" }, host: { listeners: { "click": "onClick($event.button,$event.ctrlKey,$event.shiftKey,$event.altKey,$event.metaKey)" }, properties: { "attr.target": "this.target", "attr.href": "this.href" } }, usesOnChanges: true, ngImport: i0 });
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: RouterLinkWithHref, decorators: [{
            type: Directive,
            args: [{ selector: 'a[routerLink],area[routerLink]' }]
        }], ctorParameters: function () { return [{ type: Router }, { type: ActivatedRoute }, { type: LocationStrategy }]; }, propDecorators: { target: [{
                type: HostBinding,
                args: ['attr.target']
            }, {
                type: Input
...
RouterLinkActive.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: RouterLinkActive, deps: [{ token: Router }, { token: ElementRef }, { token: Renderer2 }, { token: ChangeDetectorRef }, { token: RouterLink, optional: true }, { token: RouterLinkWithHref, optional: true }], target: FactoryTarget.Directive });
RouterLinkActive.ɵdir = ɵɵngDeclareDirective({ minVersion: "12.0.0", version: "13.1.3", type: RouterLinkActive, selector: "[routerLinkActive]", inputs: { routerLinkActiveOptions: "routerLinkActiveOptions", routerLinkActive: "routerLinkActive" }, outputs: { isActiveChange: "isActiveChange" }, queries: [{ propertyName: "links", predicate: RouterLink, descendants: true }, { propertyName: "linksWithHrefs", predicate: RouterLinkWithHref, descendants: true }], exportAs: ["routerLinkActive"], usesOnChanges: true, ngImport: i0 });
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: RouterLinkActive, decorators: [{
            type: Directive,
            args: [{
...
RouterPreloader.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: RouterPreloader, deps: [{ token: Router }, { token: Compiler }, { token: Injector }, { token: PreloadingStrategy }], target: FactoryTarget.Injectable });
RouterPreloader.ɵprov = ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: RouterPreloader });
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: RouterPreloader, decorators: [{
            type: Injectable
        }], ctorParameters: function () { return [{ type: Router }, { type: Compiler }, { type: Injector }, { type: PreloadingStrategy }]; } });
...
RouterScroller.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: RouterScroller, deps: "invalid", target: FactoryTarget.Injectable });
RouterScroller.ɵprov = ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: RouterScroller });
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: RouterScroller, decorators: [{
            type: Injectable
        }], ctorParameters: function () { return [{ type: Router }, { type: ViewportScroller }, { type: undefined }]; } });
...
RouterModule.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: RouterModule, deps: [{ token: ROUTER_FORROOT_GUARD, optional: true }, { token: Router, optional: true }], target: FactoryTarget.NgModule });
RouterModule.ɵmod = ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: RouterModule, declarations: [RouterOutlet, RouterLink, RouterLinkWithHref, RouterLinkActive, ɵEmptyOutletComponent], exports: [RouterOutlet, RouterLink, RouterLinkWithHref, RouterLinkActive, ɵEmptyOutletComponent] });
RouterModule.ɵinj = ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: RouterModule });
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: RouterModule, decorators: [{
            type: NgModule,
            args: [{
...
RouterInitializer.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: RouterInitializer, deps: [{ token: Injector }], target: FactoryTarget.Injectable });
RouterInitializer.ɵprov = ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: RouterInitializer });
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: RouterInitializer, decorators: [{
            type: Injectable
